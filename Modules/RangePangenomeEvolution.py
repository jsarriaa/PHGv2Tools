...
** Works with phgv2-conda env
    ...
    parser = argparse.ArgumentParser(description=RangePangenomeEvolution.__doc__)
    ...
    open_temp_folder_RangePangenomeEvolution(hvcf_folder)

    loophvcf_files(hvcf_folder, reference_file, range_bedfile)
    ...
    #At some point, delete whole temp folder and its content
    temp_folder = f"{hvcf_folder}/temp"
    shutil.rmtree(temp_folder)
